...
<div class="col-sm-3">
	...
	<ul class="list-unstyled">
		<li class="nav-header">
			<a href="javascript:;" data-toggle="collapse" data-target="#userMenu">
		...
		<li class="nav-header">
			<a href="javascript:;" data-toggle="collapse" data-target="#menu2">
		...
		<li class="nav-header">
			<a href="javascript:;" data-toggle="collapse" data-target="#menu3">
